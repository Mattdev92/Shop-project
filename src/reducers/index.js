...
const initialState = {
  ...
  Man: [
    ...
    [jacketMan3, 'Kurtka męska model 3 ', 300,null],
    [jacketMan4, 'Kurtka męska model 4 ', 130,null],
    [tShirtMan1, 'Koszulka męska model 1 ', 20,null],
    [tShirtMan2, 'Koszulka męska model 2 ', 50,null],
    [blouseMan1, 'Bluza męska model 1 ', 20,null],
    [suiteMan1, 'Garnitur męski model 1 ', 240,null],
    [suiteMan2, 'Garnitur męski model 2 ', 340,null],
    [suiteMan3, 'Garnitur męski model 3 ', 440,null],
    [suiteMan4, 'Garnitur męski model 4 ', 2240,null],
  ],
  Woman: [
    [dressWoman1, 'Spudnica model 1 ', 50, dressWoman8],
    [dressWoman2, 'Kurtka model 1 ', 100, dressWoman9],
    [dressWoman3, 'Spodnie model 1 ', 150, dressWoman10],
    [dressWoman4, 'Sukienka model 1 ', 350, dressWoman11],
    [dressWoman5, 'Sukienka model 2 ', 250, dressWoman12],
    [dressWoman6, 'Spodnie model 2 ', 50, dressWoman13],
    [dressWoman7, 'Sukienka model 3 ', 350, dressWoman14],
  ],
  eventText: '',
  redirect: false,
  actualItem: '',
